...
Each vocab object MUST have these fields:
{
  ...
  "examples": ["array of 2 strings - Sentences that sound like a real American SPEAKING out loud, not a textbook or an essay. Channel how people actually talk in everyday conversation, podcasts, and interviews: relaxed, direct, concrete, and a little opinionated. Use contractions (it's, don't, you're, that's, gonna), first/second-person framing (I, you, we), short punchy clauses, strong plain verbs, and modern real-life situations (work, startups, tech, money, friends, sports, daily life). Casual intensifiers and asides are good (honestly, basically, way too, a ton of, kind of, no joke). Use American spelling and idioms (color, realize, awesome, line up). Keep the delivery casual EVEN WHEN the target word is advanced — a sharp native speaker drops a precise, fancy word straight into plain everyday speech, and that contrast is exactly the effect you want. STRICTLY AVOID stiff/formal/academic/literary phrasing, passive voice, and bookish connectors (thus, hence, moreover, furthermore, whilst, one might say). Each sentence must still make the word's meaning obvious from context. Then add TWO kinds of markup: (1) Each sentence MUST contain the word/phrase being defined (or a natural variant — different tense/number, or for an idiom a substituted word); wrap THAT target item, exactly as it appears, in {{double curly braces}}. (2) Wrap any OTHER genuinely uncommon / C1-C2 word, idiom, or advanced collocation that happens to appear — NOT the target item, and NEVER basic/common words — in [[double square brackets]] so learners can tap them to look them up; don't cram a sentence full of them, keep it sounding natural. e.g. for 'reckless': 'He was driving like a total maniac — just {{reckless}}, blowing through red lights like he was [[invincible]].' e.g. for the idiom 'fall on deaf ears': 'I kept telling them the whole plan was a huge [[liability]], but it {{fell on deaf ears}}.' and the variant 'Her [[blunt]] feedback {{fell on deaf ears}} — they just kept doing their own thing.'"],
